...
public class Walking extends AppCompatActivity implements  AMapLocationListener, View.OnClickListener{
    ...
    public void startLocation() {
        ...
        aMapLocationClientOption.setInterval(7000);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.mapButton2:
                Intent intent = new Intent(Walking.this, map1.class);
            ...
            default:
                ...
                history.save();
                Toast.makeText(Walking.this,"记录保存成功",Toast.LENGTH_SHORT).show();
                Walking.this.finish();
        }
    }
}
