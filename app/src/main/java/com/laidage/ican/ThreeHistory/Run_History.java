...
public class Run_History extends AppCompatActivity {
//历史记录
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_run__history);
        List<History> historyData = DataSupport.where("type = ?", "run").find(History.class);
        //找到类型为run的数据，放到historyData中
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<String>(Run_History.this,android.R.layout.simple_list_item_1,history);//新建适配器
