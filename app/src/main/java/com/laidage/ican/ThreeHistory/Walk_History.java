...
//历史记录
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walk__history);
        List<History> historyData = DataSupport.where("type = ?", "walk").find(History.class);
        //找到类型为walk的数据，放到historyData中
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<String>(Walk_History.this,android.R.layout.simple_list_item_1,history);//新建适配器
